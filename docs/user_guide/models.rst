...
With the 5.x releases, this repository follows the `HTRMoPo
...
**Filter logic:** Defining multiple filters of different types will **AND** them, while multiple filters of the same type will **OR** them.
