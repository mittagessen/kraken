...
_PYRNN.fields_by_name['codec'].has_options = True
_PYRNN.fields_by_name['codec']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
